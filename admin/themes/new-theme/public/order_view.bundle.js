 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const wt=new(r(7187).EventEmitter),Tt="productDeletedFromOrder",kt="productAddedToOrder",Et="productUpdated",St="productEditionCanceled",Ot="productListPaginated",Rt="productListNumberPerPage",{$:Ct}=window;class qt{constructor(){this.router=new Pt}handleDeleteProductEvent(e){e.preventDefault();const t=Ct(e.currentTarget);window.confirm(t.data("deleteMessage"))&&(t.pstooltip("dispose"),t.prop("disabled",!0),this.deleteProduct(t.data("orderId"),t.data("orderDetailId")))}deleteProduct(e,t){Ct.ajax(this.router.generate("admin_orders_delete_product",{orderId:e,orderDetailId:t}),{method:"POST"}).then((()=>{wt.emit(Tt,{oldOrderDetailId:t,orderId:e})}),(e=>{e.responseJSON&&e.responseJSON.message&&Ct.growl.error({message:e.responseJSON.message})}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:jt}=window;class Lt{constructor(){this.router=new Pt}refresh(e){jt.ajax(this.router.generate("admin_orders_get_discounts",{orderId:e})).then((e=>{jt(Xe.list).replaceWith(e)}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @copyright Since 2007 PrestaShop SA and Contributors
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */const yr=Xt,{$:Ir}=window;class Pr{constructor(){this.router=new Pt}refresh(e){Ir.getJSON(this.router.generate("admin_orders_get_prices",{orderId:e})).then((e=>{Ir(it).text(e.orderTotalFormatted),Ir(rt).text(`-${e.discountsAmountFormatted}`),Ir(tt).toggleClass("d-none",!e.discountsAmountDisplayed),Ir(et).text(e.productsTotalFormatted),Ir(st).text(e.shippingTotalFormatted),Ir(ot).toggleClass("d-none",!e.shippingTotalDisplayed),Ir(nt).text(e.taxesTotalFormatted)}))}refreshProductPrices(e){Ir.getJSON(this.router.generate("admin_orders_product_prices",{orderId:e})).then((e=>{e.forEach((e=>{const t=ne(e.orderDetailId);let r=Ir(e.quantity);e.quantity>1&&(r=r.wrap('<span class="badge badge-secondary rounded-circle"></span>')),Ir(`${t} ${Ge}`).text(e.unitPrice),Ir(`${t} ${Be}`).html(r.html()),Ir(`${t} ${Ze}`).text(e.availableQuantity),Ir(`${t} ${He}`).text(e.totalPrice);const o=Ir(me(e.orderDetailId));o.data("product-price-tax-incl",e.unitPriceTaxInclRaw),o.data("product-price-tax-excl",e.unitPriceTaxExclRaw),o.data("product-quantity",e.quantity)}))}))}checkOtherProductPricesMatch(e,t,r,o,s){const n=document.querySelectorAll("tr.cellProduct"),i=Number(t),d=Number(r),a=Number(e);let c=!1,l=!1;return n.forEach((e=>{const t=Ir(e).attr("id");if(s&&t===`orderProduct_${s}`)return;const r=Ir(`#${t} ${pe}`),n=Number(r.data("order-invoice-id")),u=Number(r.data("product-id")),h=Number(r.data("combination-id"));u===i&&h===d&&a!==Number(r.data("product-price-tax-incl"))&&(!o||o&&n&&o===n?l=!0:c=!0)})),c?"invoice":l?"product":null}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Sr}=window;class Or{constructor(){this.router=new Pt}refresh(e){Sr.ajax(this.router.generate("admin_orders_get_payments",{orderId:e})).then((e=>{Sr(d).remove(),Sr(`${i} .card-body`).prepend(e)}),(e=>{e.responseJSON&&e.responseJSON.message&&Sr.growl.error({message:e.responseJSON.message})}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Rr}=window;class Cr{constructor(){this.router=new Pt}refresh(e){Rr.getJSON(this.router.generate("admin_orders_get_shipping",{orderId:e})).then((e=>{Rr(A).text(e.total),Rr(N).html(e.html)}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:qr}=window;class jr{constructor(){this.router=new Pt}refresh(e){qr.getJSON(this.router.generate("admin_orders_get_invoices",{orderId:e})).then((e=>{if(!e||!e.invoices||Object.keys(e.invoices).length<=0)return;const t=qr(n),r=qr(qe).find("optgroup:first"),o=qr(Qe),s=qr(p);r.empty(),t.empty(),o.empty(),s.empty(),Object.keys(e.invoices).forEach((n=>{const i=e.invoices[n],d=n.split(" - ")[0];r.append(`<option value="${i}">${d}</option>`),t.append(`<option value="${i}">${d}</option>`),o.append(`<option value="${i}">${d}</option>`),s.append(`<option value="${i}">${n}</option>`)}));const i=document.querySelector(qe);i&&(i.selectedIndex=0)}))}}var Lr=r(1527);
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Dr}=window;class $r{constructor(){this.router=new Pt,this.invoiceNoteManager=new bt}refresh(e){Dr.getJSON(this.router.generate("admin_orders_get_documents",{orderId:e})).then((e=>{Dr(D).text(e.total),Dr($).html(e.html),this.invoiceNoteManager.setupListeners()}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Jr}=window;Jr((()=>{const r="free_shipping";new vt,new Ur;const o=new Nr,s=new Br(Jr(xe)),n=new Hr;o.listenForProductPack(),o.listenForProductDelete(),o.listenForProductEdit(),o.listenForProductAdd(),o.listenForProductPagination(),o.listenForRefund(),o.listenForCancelProduct(),s.listenForSearch(),s.onItemClickedCallback=e=>n.setProduct(e),Jr(t).on("click",(e=>{Jr(e.currentTarget).closest("tr").next(":first").toggleClass("d-none")})),function(){const e=Jr(u);Jr(l).on("input",(()=>{e.prop("disabled",!1)}))}(),function(){const e=Jr(pt);Jr(ht).on("input",(()=>{e.prop("disabled",!1)}))}(),function(){const e=Jr(y),t=Jr(P);Jr(I).on("change",(r=>{const o=Jr(r.currentTarget),s=Jr("option:selected",o),n=o.val();t.css("background-color",s.data("background-color")),t.toggleClass("is-bright",void 0!==s.data("is-bright")),e.prop("disabled",parseInt(n,10)===e.data("orderStatusId"))}))}(),new bt;const i=new Vr;i.listenForPredefinedMessageSelection(),i.listenForFullMessagesOpen(),Jr(a).on("click",(e=>{e.preventDefault(),function(){const e=Jr(c),t=Jr(a),r=t.hasClass("is-opened");r?(t.removeClass("is-opened"),e.addClass("d-none")):(t.addClass("is-opened"),e.removeClass("d-none"));t.find(".material-icons").text(r?"add":"remove")}()})),Jr(lt).on("click",(e=>{e.preventDefault(),function(){const e=Jr(ut),t=Jr(lt),r=t.hasClass("is-opened");t.toggleClass("is-opened",!r),e.toggleClass("d-none",r);t.find(".material-icons").text(r?"add":"remove")}()})),Jr(ct).on("click",(()=>{const t=document.title;document.title=Jr(e).data("orderTitle"),window.print(),document.title=t})),function(){const e=Jr(h),t=e.find("form"),o=e.find(p),s=e.find(x),n=t.find(v),i=n.closest(".form-group");e.on("shown.bs.modal",(()=>{Jr(b).prop("disabled",!0)})),t.find(m).on("keyup",(e=>{const t=Jr(e.currentTarget).val();Jr(b).prop("disabled",0===t.trim().length)})),t.find(_).on("change",(e=>{const t=Jr(e.currentTarget).is(":checked");o.prop("disabled",t)})),t.find(f).on("change",(e=>{const o=Jr(e.currentTarget).val(),d=t.find(g);"amount"===o?(s.removeClass("d-none"),d.html(d.data("currencySymbol"))):s.addClass("d-none"),"percent"===o&&d.html("%"),n.prop("disabled",o===r),i.toggleClass("d-none",o===r)}))}(),function(){const e=Jr(S);Jr(O).on("click",(t=>{e.find(R).val(Jr(t.currentTarget).data("addressType"))}))}(),Jr(dt).find(".nav-tabs li:first-child a").tab("show")}))})(),window.order_view=o})();